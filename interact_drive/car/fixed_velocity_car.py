...
class FixedVelocityCar(FixedControlCar):
    ...
    def __init__(
        self,
        env: "CarWorld",
        init_position: Union[np.ndarray, tf.Tensor, Iterable],
        velocity=0.4,
        heading=np.pi / 2,
        color: str = "gray",
        opacity=1.0,
        ...
        init_state[2] = velocity
        init_state[3] = heading
        super().__init__(env, init_state, controls, color, opacity, friction=0.0)
